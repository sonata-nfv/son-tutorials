...
## 5.2 Creating a network service with the SDK
...
### 5.3.2 Analysing a network service with the son-analyze
...
## 5.4 Deploying a service with the SERVICE PLATFORM

### 5.4.1 Login to SONATA Service Platform
